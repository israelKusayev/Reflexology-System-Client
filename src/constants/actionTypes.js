...
export const REQUEST_FETCH_WITHOUT_LOADER = 'REQUEST_FETCH_WITHOUT_LOADER';
...
export const GET_REMINDERS_FAILED = 'GET_REMINDERS_FAILED';

export const GET_REMINDERS_COUNT_SUCCESS = 'GET_REMINDERS_COUNT_SUCCESS';
export const GET_REMINDERS_COUNT_FAILED = 'GET_REMINDERS_COUNT_FAILED';
